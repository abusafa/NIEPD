          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white/50 text-lg"
              />
            </div>
          </div>
        </div>
                ...
                {filteredFAQs.map((faq) => {
                  ...
                  return (
                    <div key={faq.id} className="card overflow-hidden">
                      ...
                      >
                        <h3 className="text-lg font-semibold text-secondary-700 leading-relaxed flex-1">
                          {question}
                        </h3>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="card text-center group hover:scale-105 transition-all duration-300">
                ...
                <h3 className="font-bold text-secondary-700 mb-2">{t.phone}</h3>
                <p className="text-secondary-600 text-sm">+966 11 123 4567</p>
              </div>
              ...
              <div className="card text-center group hover:scale-105 transition-all duration-300">
                ...
                <h3 className="font-bold text-secondary-700 mb-2">{t.email}</h3>
                <p className="text-secondary-600 text-sm">support@niepd.futurex.sa</p>
              </div>
              
              <div className="card text-center group hover:scale-105 transition-all duration-300">
                <div className="w-12 h-12 bg-accent-green-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <MessageCircle className="w-6 h-6 text-accent-green-600" />
                </div>
                <h3 className="font-bold text-secondary-700 mb-2">{t.liveChat}</h3>
                <p className="text-secondary-600 text-sm">
                  {currentLang === 'ar' ? 'متاح 24/7' : 'Available 24/7'}
                </p>
              </div>
            </div>
          </div>
