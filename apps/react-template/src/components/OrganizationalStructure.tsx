...
import { dataService, OrganizationalStructure as OrgStructureType } from '../services/dataService';
...
const OrganizationalStructure: React.FC<OrganizationalStructureProps> = ({ currentLang }) => {
  ...
  const [organizationData, setOrganizationData] = useState<OrgStructureType | null>(null);
